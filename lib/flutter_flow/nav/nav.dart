...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/diseasePage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'diseasePage')
              : DiseasePageWidget(),
        ),
        FFRoute(
          name: 'diseasedetailsPage',
          path: '/diseasedetailsPage',
          builder: (context, params) => DiseasedetailsPageWidget(),
        ),
        FFRoute(
          name: 'suggestionPage',
          path: '/suggestionPage',
          builder: (context, params) => SuggestionPageWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Coco_(390_x_844_px).png',
                    fit: BoxFit.fill,
                  ),
                )
              : page;
